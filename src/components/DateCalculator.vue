...
<template>
  <div class="date-calculator">
    ...
    <div v-if="selectedType === 'dateDiff'" class="calculation-panel">
      ...
      <button @click="calculateDateDifference" class="btn">计算</button>
    ...
    <div v-if="selectedType === 'dateAdd'" class="calculation-panel">
      ...
      <div class="form-group">
        <label>天数:</label>
        <input type="number" v-model.number="daysToAddOrSubtract" min="0">
      </div>
      
      <button @click="calculateDateAddSubtract" class="btn">计算</button>
